...
import { View, TouchableOpacity, StyleSheet, ImageBackground, Alert, Platform, Text } from 'react-native';
...
const voiceAssistantBg = require('@/assets/voice-assistant-bg.jpg');
const videoCallBg = require('@/assets/video-call-bg.png');
const emergencyCallBg = require('@/assets/emergency-call-bg.png');
      ...
      <View style={styles.container}>
        ...
        <View style={styles.headerRow}>
          ...
          <TouchableOpacity 
            ...
            activeOpacity={0.7}
          >
            <FontAwesome6 name="bell" size={28} color={colors.textPrimary} />
            {unreadCount > 0 && (
        ...
        <View style={styles.buttonContainer}>
          ...
          <TouchableOpacity style={styles.largeButton} onPress={handleVoiceAssistant} activeOpacity={0.8}>
            <ImageBackground source={voiceAssistantBg} style={styles.buttonBackground} imageStyle={styles.buttonBackgroundImage}>
          ...
          <TouchableOpacity 
            ...
            disabled={isCalling}
          >
            <ImageBackground source={videoCallBg} style={styles.buttonBackground} imageStyle={styles.buttonBackgroundImage}>
          ...
          <TouchableOpacity style={[styles.largeButton, styles.emergencyButton]} onPress={handleEmergencyCall} activeOpacity={0.8}>
            <ImageBackground source={emergencyCallBg} style={styles.buttonBackground} imageStyle={styles.buttonBackgroundImage}>
