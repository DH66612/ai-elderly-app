    ...
    <Screen backgroundColor="transparent" statusBarStyle="dark">
      ...
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <ThemedText variant="h2" color={colors.textPrimary}>健康手环</ThemedText>
          <View style={{ width: 40 }} />
        </View>
        ...
        <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
          ...
          {/* 华为健康入口 */}
          <TouchableOpacity 
            style={styles.huaweiHealthEntry}
            onPress={() => router.push('/huawei-health')}
          >
            <View style={[styles.deviceIcon, { backgroundColor: '#FEE2E2' }]}>
              <FontAwesome6 name="heart-circle-check" size={24} color="#CF0A2C" />
            </View>
            <View style={styles.huaweiHealthInfo}>
              <ThemedText variant="bodyMedium" color={colors.textPrimary}>华为健康</ThemedText>
              <ThemedText variant="small" color={colors.textSecondary}>同步华为/荣耀设备数据</ThemedText>
            </View>
...
const createStyles = (_theme: Theme) => StyleSheet.create({
  ...
  huaweiHealthInfo: { flex: 1, marginLeft: Spacing.sm },
