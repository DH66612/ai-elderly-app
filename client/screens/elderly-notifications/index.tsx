...
const colors = {
  ...
  // 消息类型颜色（粉彩系）
  medication: '#86efac',
  medicationBg: 'rgba(134,239,172,0.15)',
  weather: '#54A0FF',
  weatherBg: 'rgba(84,160,255,0.15)',
  health: '#fca5a5',
  healthBg: 'rgba(252,165,165,0.15)',
  festival: '#fcd34d',
  festivalBg: 'rgba(252,211,77,0.15)',
  system: '#a78bfa',
  systemBg: 'rgba(167,139,250,0.15)',
...
export default function ElderlyNotificationsScreen() {
  ...
  const handleNotificationPress = (item: Notification) => {
    ...
    // 跳转到详情页面
    router.push('/elderly-notification-detail', {
      id: String(item.id),
      type: item.type,
