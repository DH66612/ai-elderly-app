          ...
          <View style={styles.block}>
            ...
            <View style={styles.deviceGrid}>
              ...
              >
                ...
                <Text style={styles.deviceLabel}>通用手环</Text>
                <Text style={styles.deviceHint}>蓝牙配对</Text>
              </TouchableOpacity>
              ...
              {/* 华为健康 */}
              <TouchableOpacity 
                style={[styles.deviceEntry, { backgroundColor: '#FEE2E2' }]} 
                onPress={() => router.push('/huawei-health')}
              >
                <View style={styles.deviceIcon}>
                  <FontAwesome6 name="heart-circle-check" size={24} color="#CF0A2C" />
                </View>
                <Text style={styles.deviceLabel}>华为健康</Text>
                <Text style={styles.deviceHint}>数据同步</Text>
              </TouchableOpacity>
            </View>
          </View>
